...
function getJSONTestDistortionDemo() {
	return "{\"name\":\"distortion\",\"filename\":\"TestDistortionDemo\",\"version\":\"2.11.10\",\"compile_options\":\"-scal -ftz 2\",\"library_list\":[\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/demos.lib\",\"/usr/local/share/faust/signals.lib\",\"/usr/local/share/faust/misceffects.lib\",\"/usr/local/share/faust/filters.lib\",\"/usr/local/share/faust/basics.lib\"],\"include_pathnames\":[\"src/TestDistortion\",\"/usr/local/share/faust\",\"/usr/share/faust\",\"/home/ben/Drive/Business/Brainstem/brainstem/src/TestDistortion\"],\"size\":\"48\",\"inputs\":\"1\",\"outputs\":\"1\",\"meta\":[{\"author\":\"JOS, revised by RM\"},{\"basics.lib/name\":\"Faust Basic Element Library\"},{\"basics.lib/version\":\"0.0\"},{\"description\":\"Distortion demo application.\"},{\"filename\":\"TestDistortionDemo\"},{\"filters.lib/name\":\"Faust Filters Library\"},{\"filters.lib/version\":\"0.0\"},{\"misceffects.lib/name\":\"Faust Math Library\"},{\"misceffects.lib/version\":\"2.0\"},{\"name\":\"distortion\"},{\"signals.lib/name\":\"Faust Signal Routing Library\"},{\"signals.lib/version\":\"0.0\"},{\"version\":\"0.0\"}],\"ui\":[{\"type\":\"vgroup\",\"label\":\"CUBIC NONLINEARITY cubicnl\",\"meta\":[{\"tooltip\":\"Reference:   https://ccrma.stanford.edu/~jos/pasp/Cubic_Soft_Clipper.html\"}],\"items\":[{\"type\":\"checkbox\",\"label\":\"Bypass\",\"address\":\"/CUBIC_NONLINEARITY_cubicnl/Bypass\",\"index\":\"0\",\"meta\":[{\"0\":\"\"},{\"tooltip\":\"When this is checked, the   nonlinearity has no effect\"}]},{\"type\":\"hslider\",\"label\":\"Drive\",\"address\":\"/CUBIC_NONLINEARITY_cubicnl/Drive\",\"index\":\"16\",\"meta\":[{\"1\":\"\"},{\"tooltip\":\"Amount of distortion\"}],\"init\":\"0\",\"min\":\"0\",\"max\":\"1\",\"step\":\"0.01\"},{\"type\":\"hslider\",\"label\":\"Offset\",\"address\":\"/CUBIC_NONLINEARITY_cubicnl/Offset\",\"index\":\"4\",\"meta\":[{\"2\":\"\"},{\"tooltip\":\"Brings in even harmonics\"}],\"init\":\"0\",\"min\":\"0\",\"max\":\"1\",\"step\":\"0.01\"}]}]}";
}
/*
 faust2webaudio
...
*/
faust.TestDistortionDemo = function (dsp_instance, context, buffer_size) {
    ...
    try {
        json_object = JSON.parse(getJSONTestDistortionDemo());
    } catch (e) {
    ...
    */
    sp.getJSON = function ()
    {
        return getJSONTestDistortionDemo();
    }
...
*/
faust.createTestDistortionDemo = function(context, buffer_size, callback)
{
    var importObject = {
        env: {
            memoryBase: 0,
    ...
    fetch('TestDistortionDemo.wasm')
    .then(dsp_file => dsp_file.arrayBuffer())
    .then(dsp_bytes => WebAssembly.instantiate(dsp_bytes, importObject))
    .then(dsp_module => callback(faust.TestDistortionDemo(dsp_module.instance, context, buffer_size)))
    .catch(function(error) { console.log(error); faust.error_msg = "Faust TestDistortionDemo cannot be loaded or compiled"; callback(null); });
}
